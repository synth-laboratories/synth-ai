...
class _SwarmReadoutBound:
    def __init__(self, handle: Any) -> None:
        self._handle = handle


class ResearchSwarmUsageActorsAPI(_SwarmReadoutBound):
...
class ResearchSwarmUsageCostAPI(_SwarmReadoutBound):
...
class ResearchSwarmUsageLimitsAPI(_SwarmReadoutBound):
...
class ResearchSwarmUsageAPI(_SwarmReadoutBound):
    """Token, cost, and limit readouts for a swarm."""

    def __init__(self, handle: Any) -> None:
        super().__init__(handle)
        self._actors: ResearchSwarmUsageActorsAPI | None = None
        self._cost: ResearchSwarmUsageCostAPI | None = None
        self._limits: ResearchSwarmUsageLimitsAPI | None = None

    @property
    def actors(self) -> ResearchSwarmUsageActorsAPI:
        """Per-actor usage slice."""
        if self._actors is None:
            self._actors = ResearchSwarmUsageActorsAPI(self._handle)
        return self._actors

    @property
    def cost(self) -> ResearchSwarmUsageCostAPI:
        """Run cost summary slice."""
        if self._cost is None:
            self._cost = ResearchSwarmUsageCostAPI(self._handle)
        return self._cost

    @property
    def limits(self) -> ResearchSwarmUsageLimitsAPI:
        """Resource limit and progress slice."""
        if self._limits is None:
            self._limits = ResearchSwarmUsageLimitsAPI(self._handle)
        return self._limits
...
class ResearchSwarmProgressAPI(_SwarmReadoutBound):
    ...
    def get_typed(self) -> ResearchSwarmProgress:
        """Return typed state, phase, stalls, tasks, and recommended actions."""
        return ResearchSwarmProgress.from_wire(self.get())


class ResearchSwarmSnapshotsAPI(_SwarmReadoutBound):
...
class ResearchSwarmEventsObjectivesAPI(_SwarmReadoutBound):
...
class ResearchSwarmEventsTasksAPI(_SwarmReadoutBound):
...
class ResearchSwarmEventsAPI(_SwarmReadoutBound):
    """Structured and streaming runtime events for a swarm."""

    def __init__(self, handle: Any) -> None:
        super().__init__(handle)
        self._objectives: ResearchSwarmEventsObjectivesAPI | None = None
        self._tasks: ResearchSwarmEventsTasksAPI | None = None

    @property
    def objectives(self) -> ResearchSwarmEventsObjectivesAPI:
        """Objective-scoped event list."""
        if self._objectives is None:
            self._objectives = ResearchSwarmEventsObjectivesAPI(self._handle)
        return self._objectives

    @property
    def tasks(self) -> ResearchSwarmEventsTasksAPI:
        """Task-scoped event list."""
        if self._tasks is None:
            self._tasks = ResearchSwarmEventsTasksAPI(self._handle)
        return self._tasks
...
class ResearchSwarmTasksAPI(_SwarmReadoutBound):
...
class ResearchSwarmMessageQueueMessagesAPI(_SwarmReadoutBound):
...
class ResearchSwarmMessageQueueThreadsAPI(_SwarmReadoutBound):
...
class ResearchSwarmMessageQueueInteractionsAPI(_SwarmReadoutBound):
...
class ResearchSwarmMessageQueueAPI(_SwarmReadoutBound):
    """Operator steering via threads, messages, and interactions."""

    def __init__(self, handle: Any) -> None:
        super().__init__(handle)
        self._messages: ResearchSwarmMessageQueueMessagesAPI | None = None
        self._threads: ResearchSwarmMessageQueueThreadsAPI | None = None
        self._interactions: ResearchSwarmMessageQueueInteractionsAPI | None = None

    @property
    def messages(self) -> ResearchSwarmMessageQueueMessagesAPI:
        """Outbound messages API."""
        if self._messages is None:
            self._messages = ResearchSwarmMessageQueueMessagesAPI(self._handle)
        return self._messages

    @property
    def threads(self) -> ResearchSwarmMessageQueueThreadsAPI:
        """Thread listing API."""
        if self._threads is None:
            self._threads = ResearchSwarmMessageQueueThreadsAPI(self._handle)
        return self._threads

    @property
    def interactions(self) -> ResearchSwarmMessageQueueInteractionsAPI:
        """Interaction listing API."""
        if self._interactions is None:
            self._interactions = ResearchSwarmMessageQueueInteractionsAPI(self._handle)
        return self._interactions


class ResearchSwarmRuntimeMessagesAPI(_SwarmReadoutBound):
...
class ResearchSwarmTranscriptAPI(_SwarmReadoutBound):
...
class ResearchSwarmMilestonesAPI(_SwarmReadoutBound):
...
class ResearchSwarmWorkProductsContentAPI(_SwarmReadoutBound):
...
class ResearchSwarmTrainedModelsAPI(_SwarmReadoutBound):
...
class ResearchSwarmWorkProductsEvalPackagesAPI(_SwarmReadoutBound):
...
class ResearchSwarmWorkProductsAPI(_SwarmReadoutBound):
    """Work products and derived outputs from a run."""

    def __init__(self, handle: Any) -> None:
        super().__init__(handle)
        self._content: ResearchSwarmWorkProductsContentAPI | None = None
        self._eval_packages: ResearchSwarmWorkProductsEvalPackagesAPI | None = None

    @property
    def content(self) -> ResearchSwarmWorkProductsContentAPI:
        """Download work product bodies."""
        if self._content is None:
            self._content = ResearchSwarmWorkProductsContentAPI(self._handle)
        return self._content

    @property
    def eval_packages(self) -> ResearchSwarmWorkProductsEvalPackagesAPI:
        """List container eval packages."""
        if self._eval_packages is None:
            self._eval_packages = ResearchSwarmWorkProductsEvalPackagesAPI(self._handle)
...
class ResearchSwarmHostedArtifactsAPI(_SwarmReadoutBound):
...
class ResearchSwarmArtifactsManifestAPI(_SwarmReadoutBound):
...
class ResearchSwarmArtifactsContentAPI(_SwarmReadoutBound):
...
class ResearchSwarmArtifactsAPI(_SwarmReadoutBound):
    """Run artifacts listing, manifest, and content download."""

    def __init__(self, handle: Any) -> None:
        super().__init__(handle)
        self._manifest: ResearchSwarmArtifactsManifestAPI | None = None
        self._content: ResearchSwarmArtifactsContentAPI | None = None

    @property
    def manifest(self) -> ResearchSwarmArtifactsManifestAPI:
        """Artifact manifest API."""
        if self._manifest is None:
            self._manifest = ResearchSwarmArtifactsManifestAPI(self._handle)
        return self._manifest

    @property
    def content(self) -> ResearchSwarmArtifactsContentAPI:
        """Artifact content download API."""
        if self._content is None:
            self._content = ResearchSwarmArtifactsContentAPI(self._handle)
        return self._content
...
class ResearchSwarmResultsAPI(_SwarmReadoutBound):
...
class ResearchSwarmLogsAPI(_SwarmReadoutBound):
...
class ResearchSwarmOrchestratorAPI(_SwarmReadoutBound):
...
class ResearchSwarmWorkspaceAPI(_SwarmReadoutBound):
...
class ResearchSwarmCodeAPI(_SwarmReadoutBound):
...
class ResearchSwarmActorsAPI(_SwarmReadoutBound):
...
class ResearchSwarmEvidenceAPI(_SwarmReadoutBound):
...
class ResearchSwarmAuthorityAPI(_SwarmReadoutBound):
...
class ResearchSwarmExecutionAPI(_SwarmReadoutBound):
...
class ResearchSwarmTickingAPI(_SwarmReadoutBound):
...
class ResearchSwarmReadoutsMixin:
    ...
    _usage_api: ResearchSwarmUsageAPI | None = None
    _progress_api: ResearchSwarmProgressAPI | None = None
    _snapshots_api: ResearchSwarmSnapshotsAPI | None = None
    _events_api: ResearchSwarmEventsAPI | None = None
    _tasks_api: ResearchSwarmTasksAPI | None = None
    _message_queue_api: ResearchSwarmMessageQueueAPI | None = None
    _messages_api: ResearchSwarmRuntimeMessagesAPI | None = None
    _transcript_api: ResearchSwarmTranscriptAPI | None = None
    _work_products_api: ResearchSwarmWorkProductsAPI | None = None
    _hosted_artifact_api: ResearchSwarmHostedArtifactsAPI | None = None
    _trained_models_api: ResearchSwarmTrainedModelsAPI | None = None
    _artifacts_api: ResearchSwarmArtifactsAPI | None = None
    _results_api: ResearchSwarmResultsAPI | None = None
    _logs_api: ResearchSwarmLogsAPI | None = None
    _orchestrator_api: ResearchSwarmOrchestratorAPI | None = None
    _workspace_api: ResearchSwarmWorkspaceAPI | None = None
    _code_api: ResearchSwarmCodeAPI | None = None
    _actors_api: ResearchSwarmActorsAPI | None = None
    _evidence_api: ResearchSwarmEvidenceAPI | None = None
    _authority_api: ResearchSwarmAuthorityAPI | None = None
    _execution_api: ResearchSwarmExecutionAPI | None = None
    _milestones_api: ResearchSwarmMilestonesAPI | None = None
    _ticking_api: ResearchSwarmTickingAPI | None = None

    @property
    def usage(self) -> ResearchSwarmUsageAPI:
        """Usage, cost, and limit readouts."""
        if self._usage_api is None:
            self._usage_api = ResearchSwarmUsageAPI(self)  # type: ignore[arg-type]
        return self._usage_api

    @property
    def progress(self) -> ResearchSwarmProgressAPI:
        """Coarse progress for polling UIs."""
        if self._progress_api is None:
            self._progress_api = ResearchSwarmProgressAPI(self)  # type: ignore[arg-type]
        return self._progress_api

    @property
    def snapshots(self) -> ResearchSwarmSnapshotsAPI:
        """Observability snapshots (control or full)."""
        if self._snapshots_api is None:
            self._snapshots_api = ResearchSwarmSnapshotsAPI(self)  # type: ignore[arg-type]
        return self._snapshots_api

    @property
    def events(self) -> ResearchSwarmEventsAPI:
        """Structured and streaming runtime events."""
        if self._events_api is None:
            self._events_api = ResearchSwarmEventsAPI(self)  # type: ignore[arg-type]
        return self._events_api

    @property
    def tasks(self) -> ResearchSwarmTasksAPI:
        """Task summaries for the swarm."""
        if self._tasks_api is None:
            self._tasks_api = ResearchSwarmTasksAPI(self)  # type: ignore[arg-type]
        return self._tasks_api

    @property
    def message_queue(self) -> ResearchSwarmMessageQueueAPI:
        """Operator message queue threads and outbound messages."""
        if self._message_queue_api is None:
            self._message_queue_api = ResearchSwarmMessageQueueAPI(self)  # type: ignore[arg-type]
        return self._message_queue_api

    @property
    def messages(self) -> ResearchSwarmRuntimeMessagesAPI:
        """Runtime messages visible to operators."""
        if self._messages_api is None:
            self._messages_api = ResearchSwarmRuntimeMessagesAPI(self)  # type: ignore[arg-type]
        return self._messages_api

    @property
    def transcript(self) -> ResearchSwarmTranscriptAPI:
        """Transcript pages with optional cursor pagination."""
        if self._transcript_api is None:
            self._transcript_api = ResearchSwarmTranscriptAPI(self)  # type: ignore[arg-type]
        return self._transcript_api

    @property
    def work_products(self) -> ResearchSwarmWorkProductsAPI:
        """Work products produced by the run."""
        if self._work_products_api is None:
            self._work_products_api = ResearchSwarmWorkProductsAPI(self)  # type: ignore[arg-type]
        return self._work_products_api

    @property
    def hosted_artifact(self) -> ResearchSwarmHostedArtifactsAPI:
        """Hosted Open Research artifact receipt for the swarm."""
        if self._hosted_artifact_api is None:
            self._hosted_artifact_api = ResearchSwarmHostedArtifactsAPI(self)  # type: ignore[arg-type]
        return self._hosted_artifact_api

    @property
    def trained_models(self) -> ResearchSwarmTrainedModelsAPI:
        """Trained models registered for the swarm."""
        if self._trained_models_api is None:
            self._trained_models_api = ResearchSwarmTrainedModelsAPI(self)  # type: ignore[arg-type]
        return self._trained_models_api

    @property
    def artifacts(self) -> ResearchSwarmArtifactsAPI:
        """Run artifacts listing and download."""
        if self._artifacts_api is None:
            self._artifacts_api = ResearchSwarmArtifactsAPI(self)  # type: ignore[arg-type]
        return self._artifacts_api

    @property
    def results(self) -> ResearchSwarmResultsAPI:
        """Final run results when execution completes."""
        if self._results_api is None:
            self._results_api = ResearchSwarmResultsAPI(self)  # type: ignore[arg-type]
        return self._results_api

    @property
    def logs(self) -> ResearchSwarmLogsAPI:
        """Structured run logs."""
        if self._logs_api is None:
            self._logs_api = ResearchSwarmLogsAPI(self)  # type: ignore[arg-type]
        return self._logs_api

    @property
    def orchestrator(self) -> ResearchSwarmOrchestratorAPI:
        """Orchestrator readouts for the swarm."""
        if self._orchestrator_api is None:
            self._orchestrator_api = ResearchSwarmOrchestratorAPI(self)  # type: ignore[arg-type]
        return self._orchestrator_api

    @property
    def workspace(self) -> ResearchSwarmWorkspaceAPI:
        """Run workspace archive download."""
        if self._workspace_api is None:
            self._workspace_api = ResearchSwarmWorkspaceAPI(self)  # type: ignore[arg-type]
        return self._workspace_api

    @property
    def code(self) -> ResearchSwarmCodeAPI:
        """Run code archive download."""
        if self._code_api is None:
            self._code_api = ResearchSwarmCodeAPI(self)  # type: ignore[arg-type]
        return self._code_api

    @property
    def actors(self) -> ResearchSwarmActorsAPI:
        """Runtime actor inventory."""
        if self._actors_api is None:
            self._actors_api = ResearchSwarmActorsAPI(self)  # type: ignore[arg-type]
        return self._actors_api

    @property
    def evidence(self) -> ResearchSwarmEvidenceAPI:
        """Operator evidence bundle for debugging."""
        if self._evidence_api is None:
            self._evidence_api = ResearchSwarmEvidenceAPI(self)  # type: ignore[arg-type]
        return self._evidence_api

    @property
    def authority(self) -> ResearchSwarmAuthorityAPI:
        """Authority and permission readouts."""
        if self._authority_api is None:
            self._authority_api = ResearchSwarmAuthorityAPI(self)  # type: ignore[arg-type]
        return self._authority_api

    @property
    def execution(self) -> ResearchSwarmExecutionAPI:
        """Execution state readouts."""
        if self._execution_api is None:
            self._execution_api = ResearchSwarmExecutionAPI(self)  # type: ignore[arg-type]
        return self._execution_api

    @property
    def milestones(self) -> ResearchSwarmMilestonesAPI:
        """Swarm-scoped milestone readouts."""
        if self._milestones_api is None:
            self._milestones_api = ResearchSwarmMilestonesAPI(self)  # type: ignore[arg-type]
        return self._milestones_api

    @property
    def ticking(self) -> ResearchSwarmTickingAPI:
        """Run ticking / heartbeat controls."""
        if self._ticking_api is None:
            self._ticking_api = ResearchSwarmTickingAPI(self)  # type: ignore[arg-type]
