...
_demo_cli = cast(Any, importlib.import_module("synth_ai.core.demo_apps.core.cli"))
...
@click.pass_context
def demo(ctx: click.Context, force: bool, list_only: bool, filter_term: str) -> None:
    ...
    if list_only:
        ...
        try:
            ...
            click.echo("")
            click.echo("🛑 Demo interrupted by user")
        return
...
def deploy(app: str | None, name: str) -> None:
    _run_demo_command(_demo_cli.deploy, app=app, name=name)
