    ...
    try:
        ...
        if sessions_df:
            ...
            for sess in sessions_df:
                ...
                print(f"    Timesteps: {sess['num_timesteps']}, Events: {sess['num_events']}, Messages: {sess['num_messages']}")
    finally:
        await db.close()


async def show_model_usage(db_url: str, model_name: str = None):
...
async def main():
    ...
    parser.add_argument("-u", "--url", default="sqlite+libsql://http://127.0.0.1:8080", 
                       help="Turso database URL")
