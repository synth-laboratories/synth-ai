...
def build_prompt_learning_payload(
    *,
    ...
    if isinstance(raw_prompt_learning, dict) and isinstance(raw_prompt_learning.get("policy"), dict):
        config_dict.setdefault("prompt_learning", {})["policy"] = dict(raw_prompt_learning["policy"])
