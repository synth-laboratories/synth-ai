...
try:
    from synth_ai.sdk.optimization.internal.configs.rl import RLConfig
except ImportError:  # RL configs moved to research repo
    RLConfig = None

try:
    from synth_ai.sdk.optimization.internal.configs.sft import SFTConfig
except ImportError:  # SFT configs moved to research repo
    SFTConfig = None
from synth_ai.sdk.optimization.internal.utils import load_toml
