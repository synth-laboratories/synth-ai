...
class PromptLearningJob:
    ...
    def submit(self) -> str:
        ...
        # Submit job
        create_url = f"{ensure_api_base(self.config.backend_url)}/policy-optimization/online/jobs"
        headers = {
        ...
        if resp.status_code not in (200, 201):
            ...
            if resp.status_code == 404:
                error_msg += (
                    f"\n\nPossible causes:"
                    f"\n1. Backend route /api/policy-optimization/online/jobs not registered"
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        from synth_ai.sdk.optimization._impl.learning.prompt_learning_client import (
    ...
    def cancel(self, *, reason: Optional[str] = None) -> Dict[str, Any]:
        ...
        url = f"{ensure_api_base(self.config.backend_url)}/policy-optimization/online/jobs/{self._job_id}/cancel"
    ...
    def query_workflow_state(self) -> Dict[str, Any]:
        ...
        url = f"{ensure_api_base(self.config.backend_url)}/jobs/{self._job_id}/workflow-state"
