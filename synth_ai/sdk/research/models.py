...
Typed wire models live in the canonical ``synth_ai.sdk.research.contracts.wire_models`` package.
Import these names from ``synth_ai.sdk.research.models`` in customer code.
...
from synth_ai.sdk.research.contracts.economics import (
...
from synth_ai.sdk.research.contracts.run_state import ManagedResearchRun as ResearchRun
...
from synth_ai.sdk.research.contracts.smr_agent_models import (
...
from synth_ai.sdk.research.contracts.smr_runnable_project import (
    SmrAgentProfileBindings as ResearchAgentProfileBindings,
)
from synth_ai.sdk.research.contracts.smr_runnable_project import (
    SmrRunnableProjectRequest as ResearchRunnableProjectRequest,
)
from synth_ai.sdk.research.contracts.smr_runtime_kinds import (
...
from synth_ai.sdk.research.contracts.types import RunArtifact as ResearchArtifact
