...
from synth_ai.sdk.research.contracts._environment_wire import digest, integer, text
...
from synth_ai.sdk.research.contracts.environment_manifest import EnvironmentManifest
