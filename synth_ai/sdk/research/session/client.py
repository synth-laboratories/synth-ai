...
from synth_ai.sdk.research._internal.crypto import encrypt_for_backend
...
from synth_ai.sdk.research.contracts.cloud_deployment_claims import ClaimAcquireRequest
from synth_ai.sdk.research.contracts.cloud_deployments import (
...
from synth_ai.sdk.research.contracts.smr_agent_harnesses import (
    SmrAgentHarness,
    coerce_smr_agent_harness,
)
from synth_ai.sdk.research.contracts.smr_agent_kinds import (
    SmrAgentKind,
...
from synth_ai.sdk.research.contracts.smr_funding_sources import (
    SmrFundingSource,
    coerce_smr_funding_source,
)
from synth_ai.sdk.research.contracts.smr_horizons import (
    SmrIntendedHorizonHours,
    coerce_intended_horizon_hours,
)
from synth_ai.sdk.research.contracts.smr_host_kinds import (
    SmrHostKind,
...
from synth_ai.sdk.research.contracts.smr_work_modes import (
    SmrWorkMode,
...
from synth_ai.sdk.research.session._run_authority_mixin import (
...
from synth_ai.sdk.research.session.images import ImagesAPI
...
from synth_ai.sdk.research.session.trained_models import TrainedModelsAPI
from synth_ai.sdk.research.session.transport import build_http_transport
...
def _build_project_run_payload(
    *,
    ...
    if provider_values is not None:
        ...
        payload["providers"] = [binding.to_wire() for binding in normalized_provider_bindings]
...
@dataclass
class ResearchSession(ManagedResearchRunAuthorityMixin):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"ResearchSession(backend_base={self.backend_base!r}, "
    ...
    def set_provider_key(
        ...
        *,
        ...
        if api_key and api_key.strip():
            # Seal locally: plaintext provider secrets never cross the API boundary.
