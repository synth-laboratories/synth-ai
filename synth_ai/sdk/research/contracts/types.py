...
from synth_ai.sdk.research.contracts.smr_network_topology import (
    SmrNetworkTopology,
...
from synth_ai.sdk.research.contracts.smr_runnable_project import (  # noqa: F401 - re-exported
...
class KickoffContract:
    ...
    trace_capture: dict[str, object] = field(default_factory=dict)
    ...
    def from_wire(cls, payload: object) -> KickoffContract:
        ...
        return cls(
            ...
            trace_capture=_optional_object_dict(mapping.get("trace_capture")),
