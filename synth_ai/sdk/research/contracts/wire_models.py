"""Aggregate re-export of the Research wire model contracts.

Grouped import surface for the operator namespaces. New code should import the
owning ``synth_ai.sdk.research.contracts.<domain>`` module directly.
"""
...
from synth_ai.sdk.research.contracts.run_execution import (
    RunExecutionActor,
    RunExecutionCursor,
    RunExecutionEvent,
    RunExecutionMessage,
