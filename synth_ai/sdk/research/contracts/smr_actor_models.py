...
(synced into smr_actor_policy_data.py via python -m synth_ai.sdk.research.schema_sync).
"""
...
from synth_ai.sdk.research.contracts.smr_actor_policy_data import (
    ...
    *,
    ...
    if assignment.agent_model.value not in permitted:
        raise ValueError(
            ...
            "synth_ai.sdk.research.contracts.smr_actor_policy_data via "
            "`python -m synth_ai.sdk.research.schema_sync` against a sibling backend checkout."
        )
    return assignment
