"""Factory/Effort wire payload builders and operator projections.

This module owns the request payload builders and the operator-facing
Factory, Effort, Idea, Result, and Champion projections used by the advanced
Research namespaces. The stable, id-typed Factory contract lives in
``synth_ai.sdk.research.contracts.factories``; the overlapping ``Factory``
...
from synth_ai.sdk.research.contracts.scientific_integrity import (
    SmrEvaluationMode,
