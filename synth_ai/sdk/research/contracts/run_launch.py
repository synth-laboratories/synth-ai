...
from synth_ai.sdk.research.contracts.local_execution_profile import LocalExecutionProfile
from synth_ai.sdk.research.contracts.run_events import (
    RunRuntimeStreamEvent,
    RunRuntimeStreamEventKind,
    TranscriptEvent,
)
from synth_ai.sdk.research.contracts.run_observability import RunObservabilitySnapshot
from synth_ai.sdk.research.contracts.runtime_image import (
    EnvironmentSpec,
    RuntimeImage,
    SandboxOverride,
...
from synth_ai.sdk.research.contracts.smr_actor_models import SmrActorModelAssignment
...
from synth_ai.sdk.research.contracts.smr_roles import SmrRoleBindings
from synth_ai.sdk.research.contracts.smr_run_policy import SmrRunPolicy
from synth_ai.sdk.research.contracts.smr_runbooks import SmrRunbookKind
...
class RunLaunchRequest(CommandRequest):
    ...
    def to_wire(self) -> WirePayload:
        from synth_ai.sdk.research.session.client import _build_project_run_payload
