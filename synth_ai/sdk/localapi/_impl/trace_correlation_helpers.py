...
def extract_trace_correlation_id(
    ...
    if synth_ai_py is not None and hasattr(synth_ai_py, "localapi_extract_trace_correlation_id"):
...
def validate_trace_correlation_id(
    ...
    *,
    ...
    if synth_ai_py is not None and hasattr(synth_ai_py, "localapi_validate_trace_correlation_id"):
...
def include_trace_correlation_id_in_response(
    ...
    if synth_ai_py is not None and hasattr(
        synth_ai_py, "localapi_include_trace_correlation_id_in_response"
    ):
...
def build_trace_payload(
    ...
    *,
    ...
    if synth_ai_py is not None and hasattr(synth_ai_py, "localapi_build_trace_payload"):
...
def build_trajectory_trace(
    ...
    *,
    ...
    if synth_ai_py is not None and hasattr(synth_ai_py, "localapi_build_trajectory_trace"):
...
def include_event_history_in_response(
    ...
    *,
    ...
    if synth_ai_py is not None and hasattr(
        synth_ai_py, "localapi_include_event_history_in_response"
    ):
...
def include_event_history_in_trajectories(
    ...
    *,
    ...
    if synth_ai_py is not None and hasattr(
        synth_ai_py, "localapi_include_event_history_in_trajectories"
    ):
...
def verify_trace_correlation_id_in_response(
    ...
    if synth_ai_py is not None and hasattr(
        synth_ai_py, "localapi_verify_trace_correlation_id_in_response"
    ):
