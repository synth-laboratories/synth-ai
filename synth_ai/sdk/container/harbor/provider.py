...
Example:
    ...
    >>> from synth_ai.sdk.container.harbor.provider import HarborInstanceProvider
...
def create_harbor_instance_provider(
    ...
    **kwargs: Any,
    ...
    Example:
        >>> from synth_ai.sdk.container.harbor.provider import create_harbor_instance_provider
        >>>
