"""
Template for creating a Container with proper trace correlation handling.

This template demonstrates the recommended patterns for building a Container
...
from synth_ai.sdk.container import ContainerConfig, create_container  # noqa: E402
from synth_ai.sdk.container._impl import (  # noqa: E402
    build_rollout_response,
    install_all_guards,
    normalize_inference_url,
)
from synth_ai.sdk.container._impl.contracts import (  # noqa: E402
    RolloutRequest,
    RolloutResponse,
    TaskInfo,
)
