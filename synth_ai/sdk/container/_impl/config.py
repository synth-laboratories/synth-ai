"""Configuration dataclasses for container CLI commands (eval, filter)."""
...
class EvalConfig:
    ...
    Validates and provides defaults for evaluation runs against containers.
    """
    ...
    # Optional: Container URL (None = spawn in-process)
