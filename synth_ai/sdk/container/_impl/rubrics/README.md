...
This module provides rubric schema, loading, evaluation, and validation utilities for Containers.
...
See these containers for real-world usage:
- `examples/containers/crafter/container/grpo_crafter.py`
- `examples/containers/verilog/container/grpo_verilog.py`
- `examples/containers/enron/container/grpo_enron.py`
...
- **Task Server**: See `synth_ai/task/server.py` for rubric integration in containers
