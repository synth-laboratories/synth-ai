...
class InferenceJobsClient:
    ...
    async def create_job(
        ...
        *,
        ...
        if artifact is not None:
            body["artifact"] = (
                artifact.to_dict() if isinstance(artifact, InferenceArtifactSpec) else dict(artifact)
            )
    ...
    async def list_artifacts(self, job_id: str, *, artifact_type: str | None = None) -> dict[str, Any]:
...
async def create_inference_job(
    *,
    ...
    client = InferenceJobsClient(_resolve_base_url(base_url), _resolve_api_key(api_key), timeout=timeout)
...
async def download_inference_artifact(
    ...
    *,
    ...
    client = InferenceJobsClient(_resolve_base_url(base_url), _resolve_api_key(api_key), timeout=timeout)
    return await client.download_artifact(job_id, artifact_id, timeout=timeout)
