"""Synth-wrapped AsyncOpenAI client with shared HTTP pool."""
...
from synth_ai.sdk.container._impl.http_pool import get_shared_http_client

DEFAULT_INTERCEPTOR_BASE_URL = resolve_synth_interceptor_base_url()


class AsyncOpenAI(_AsyncOpenAI):
    """OpenAI client that auto-routes through the Synth interceptor."""
