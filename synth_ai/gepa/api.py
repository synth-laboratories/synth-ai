...
from synth_ai.core.config.expansion import expand_gepa_config
try:
    from synth_ai.core.config.expansion import gepa_candidate_to_initial_prompt
except ImportError:
    from synth_ai.core.config.expansion import gepa_candidate_to_initial_candidate as gepa_candidate_to_initial_prompt
