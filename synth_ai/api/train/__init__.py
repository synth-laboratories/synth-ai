...
SDK Usage:
    from synth_ai.api.train import PromptLearningJob, SFTJob
...
def register(cli: Any) -> None:
    ...
    from synth_ai.api.train.cli import register as _register  # local import avoids circular dependency
...
def train_command(*args: Any, **kwargs: Any) -> Any:
    ...
    from synth_ai.api.train.cli import train_command as _train_command  # local import avoids cycle
