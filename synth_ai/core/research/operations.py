...
RESEARCH_OPERATIONS = {
    ...
    for operation in (
        ...
        _operation("create_research_environment", HttpMethod.POST, "/smr/environments", mutation=True),
        _operation("create_image_release_upload", HttpMethod.POST, "/smr/v1/image-releases/upload-url", mutation=True),
        ...
        _operation("list_customer_actor_images", HttpMethod.GET, "/smr/v1/image-releases", idempotent=True),
        _operation("list_research_environments", HttpMethod.GET, "/smr/environments", idempotent=True),
        ...
        _operation("preflight_research_environment", HttpMethod.POST, "/smr/environments/{name}/preflight"),
        ...
        _operation("finalize_image_release", HttpMethod.POST, "/smr/v1/image-releases/finalize", mutation=True),
        _operation("archive_customer_actor_image", HttpMethod.POST, "/smr/v1/image-releases/{runtime_image_release_id}/archive", mutation=True),
        ...
        _operation("retrieve_image_release", HttpMethod.GET, "/smr/v1/image-releases/{release_id}", idempotent=True),
        _operation("retrieve_research_environment", HttpMethod.GET, "/smr/environments/{name}", idempotent=True),
