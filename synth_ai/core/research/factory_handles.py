...
from synth_ai.core.research.factory_usage import (
    FactoryEventsPage,
    FactoryUsage,
...
class ResearchEffortHandle:
    ...
    def __init__(self, session: ResearchSession, effort_id: str) -> None:
...
class ResearchFactoryEffortsAPI:
    ...
    def __init__(self, session: ResearchSession, factory_id: str) -> None:
        self._session = session
