...
def fastapi_app():
    ...
    def rollout(request: dict[str, object] = Body(...)):
        ...
        trace_correlation_id = str(request.get("trace_correlation_id") or "")
        if not trace_correlation_id:
            trace_correlation_id = str(request.get("run_id") or "")
        ...
        event_rewards = [step.get("reward") for step in steps if step.get("reward") is not None]
        ...
        return {
            ...
            "metrics": {
                ...
                "event_rewards": event_rewards or None,
            },
