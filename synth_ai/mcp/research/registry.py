...
_DEFAULT_REQUIRED_SCOPES_BY_TOOL_NAME: dict[str, tuple[str, ...]] = {
    ...
    "research_list_dev_environment_topologies": READ_SCOPES,
    "research_get_dev_environment_topology": READ_SCOPES,
    "research_seed_dev_environment_topology_manifest": WRITE_SCOPES,
    "research_list_dev_environment_materialization_queue": READ_SCOPES,
    "research_list_dev_environments": READ_SCOPES,
    "research_create_dev_environment": WRITE_SCOPES,
    "research_create_dev_environment_from_topology": WRITE_SCOPES,
    "research_get_dev_environment": READ_SCOPES,
    "research_claim_dev_environment_materialization": WRITE_SCOPES,
    "research_preflight_dev_environment": READ_SCOPES,
    "research_deploy_dev_environment": WRITE_SCOPES,
    "research_start_dev_environment": WRITE_SCOPES,
    "research_stop_dev_environment": WRITE_SCOPES,
    "research_snapshot_dev_environment": WRITE_SCOPES,
    "research_report_dev_environment_materialization": WRITE_SCOPES,
    "research_destroy_dev_environment": WRITE_SCOPES,
    "research_get_dev_environment_services": READ_SCOPES,
    "research_get_dev_environment_attach": READ_SCOPES,
    "research_get_dev_environment_logs": READ_SCOPES,
    "research_get_dev_environment_runs": READ_SCOPES,
    "research_get_dev_environment_usage": READ_SCOPES,
    "research_preflight_dev_environment_billing": READ_SCOPES,
    "research_get_dev_environment_billing_drawdown": READ_SCOPES,
    "research_get_dev_environment_receipts": READ_SCOPES,
    "research_get_dev_environment_evidence": READ_SCOPES,
    "research_list_cloud_deployments": READ_SCOPES,
    "research_create_cloud_deployment": WRITE_SCOPES,
    "research_get_cloud_deployment": READ_SCOPES,
    "research_get_cloud_deployment_services": READ_SCOPES,
    "research_get_cloud_deployment_workspace": READ_SCOPES,
    "research_materialize_cloud_deployment_workspace": WRITE_SCOPES,
    "research_exec_cloud_deployment": WRITE_SCOPES,
    "research_get_cloud_deployment_logs": READ_SCOPES,
    "research_get_cloud_deployment_artifacts": READ_SCOPES,
    "research_get_cloud_deployment_artifact_content": READ_SCOPES,
    "research_observe_cloud_deployment": WRITE_SCOPES,
    "research_deploy_cloud_deployment": WRITE_SCOPES,
    "research_retire_cloud_deployment": WRITE_SCOPES,
    "research_acquire_cloud_deployment_claim": WRITE_SCOPES,
    "research_heartbeat_cloud_deployment_claim": WRITE_SCOPES,
    "research_release_cloud_deployment_claim": WRITE_SCOPES,
    "research_get_cloud_deployment_claims": READ_SCOPES,
