...
_DEFAULT_REQUIRED_SCOPES_BY_TOOL_NAME: dict[str, tuple[str, ...]] = {
    ...
    "smr_list_optimizer_campaign_events": READ_SCOPES,
    "smr_get_optimizer_campaign_integrity": READ_SCOPES,
    "smr_get_optimizer_campaign_checkpoints": READ_SCOPES,
    "smr_get_optimizer_campaign_proof": READ_SCOPES,
