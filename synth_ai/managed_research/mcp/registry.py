...
_DEFAULT_REQUIRED_SCOPES_BY_TOOL_NAME: dict[str, tuple[str, ...]] = {
    ...
    "smr_get_project_wiki": READ_SCOPES,
    "smr_list_project_wiki_pages": READ_SCOPES,
    "smr_get_project_wiki_page": READ_SCOPES,
    "smr_search_project_wiki": READ_SCOPES,
    "smr_preview_project_wiki_context_pack": READ_SCOPES,
    "smr_list_project_wiki_proposals": READ_SCOPES,
    "smr_create_project_wiki_proposal": WRITE_SCOPES,
    "smr_accept_project_wiki_proposal": WRITE_SCOPES,
    "smr_reject_project_wiki_proposal": WRITE_SCOPES,
    ...
    # Open Research v1 (public surface; reads are unscoped, submit_question writes).
    "open_research_list_projects": READ_SCOPES,
    "open_research_get_project": READ_SCOPES,
    "open_research_list_queues": READ_SCOPES,
    "open_research_submit_question": WRITE_SCOPES,
    "open_research_get_submission": READ_SCOPES,
    "open_research_list_experiments": READ_SCOPES,
    "open_research_get_experiment": READ_SCOPES,
    "open_research_get_receipt": READ_SCOPES,
    "open_research_download_bundle": READ_SCOPES,
}
