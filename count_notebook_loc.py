...
def main():
    ...
    notebooks = [
        ('Banking77 GEPA', demos_dir / 'gepa_banking77' / 'gepa_banking77_prompt_optimization.ipynb'),
        ('GEPA Crafter VLM', demos_dir / 'gepa_crafter_vlm' / 'gepa_crafter_vlm_verifier_optimization.ipynb'),
        ('Style Matching', demos_dir / 'style_matching' / 'style_matching_prompt_optimization.ipynb'),
    ]
