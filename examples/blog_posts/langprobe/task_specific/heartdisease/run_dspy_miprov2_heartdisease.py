#!/usr/bin/env python3
"""Run DSPy MIPROv2 optimization on Heart Disease classification."""
...
from dspy_heartdisease_adapter import run_dspy_miprov2_heartdisease


async def main():
    """Main entry point for Heart Disease MIPROv2 runner."""
    import argparse

    parser = argparse.ArgumentParser(description="Run DSPy MIPROv2 on Heart Disease")
    parser.add_argument(
        "--task-app-url",
