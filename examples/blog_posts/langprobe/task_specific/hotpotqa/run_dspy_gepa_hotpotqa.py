#!/usr/bin/env python3
"""Run DSPy GEPA optimization on HotPotQA multi-hop QA."""
...
from dspy_hotpotqa_adapter import run_dspy_gepa_hotpotqa


async def main():
    """Main entry point for HotPotQA GEPA runner."""
    import argparse

    parser = argparse.ArgumentParser(description="Run DSPy GEPA on HotPotQA")
    parser.add_argument(
        "--task-app-url",
