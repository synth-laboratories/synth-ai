#!/usr/bin/env python3
"""Run DSPy MIPROv2 optimization on HotPotQA multi-hop QA."""
...
from dspy_hotpotqa_adapter import run_dspy_miprov2_hotpotqa


async def main():
    """Main entry point for HotPotQA MIPROv2 runner."""
    import argparse

    parser = argparse.ArgumentParser(description="Run DSPy MIPROv2 on HotPotQA")
    parser.add_argument(
        "--task-app-url",
