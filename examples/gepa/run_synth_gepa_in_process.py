#!/usr/bin/env python3
"""
In-Process Synth GEPA Demo
==========================

This script runs Synth GEPA optimization with a task app started entirely 
...
async def main():
    """Run Synth GEPA optimization with in-process task app."""

    print("\n" + "=" * 80)
    print("In-Process Synth GEPA Demo")
    print("=" * 80 + "\n")
    ...
    try:
        async with InProcessTaskApp(
            ...
            # Create GEPA job
            print("=" * 80)
            print("Running Synth GEPA Optimization")
            print("=" * 80 + "\n")
            ...
            # Override task_app_url with our tunnel URL and set budget to 50
            import toml
            ...
            print(f"\n✅ Synth GEPA optimization complete in {total_time:.1f}s\n")
    ...
    print("=" * 80)
    print("✅ In-process Synth GEPA demo complete!")
    print("=" * 80 + "\n")
