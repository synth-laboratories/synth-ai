...
pub enum ProposerBackend {
    SinglePrompt,
    Rlm,
}

impl Default for ProposerBackend {
    fn default() -> Self {
        Self::SinglePrompt
    }
}
...
pub struct MiproConfig {
    ...
    pub seed: u64,
    /// Proposer backend for candidate generation.
    #[serde(default)]
    pub proposer_backend: ProposerBackend,
}
...
impl Default for MiproConfig {
    fn default() -> Self {
        Self {
            ...
            seed: 0,
            proposer_backend: ProposerBackend::SinglePrompt,
        }
    }
}
