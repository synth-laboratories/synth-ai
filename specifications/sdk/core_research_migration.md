...
- `openapi/research-v1.json` currently vendors 44 backend-authored operations and
  135 required schemas. `scripts/check_research_openapi_contract.py` proves byte
