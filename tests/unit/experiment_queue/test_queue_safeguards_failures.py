...
def test_should_fail_without_db_path():
    ...
    try:
        ...
        assert "EXPERIMENT_QUEUE_DB_PATH" in str(exc_info.value) or "REQUIRED" in str(
            exc_info.value
        )
    finally:
        # Restore env var
...
def test_should_require_db_path_in_cli():
    ...
    from synth_ai.cli.queue import start
...
def test_celery_app_module_level_creation_bypasses_safeguards():
    ...
    import synth_ai.core.experiment_queue.celery_app as celery_module
