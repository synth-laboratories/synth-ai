...
class TestOpenAPIPydanticValidation:
    ...
    def test_required_schemas_in_openapi(self):
        ...
        for schema_name in required_schemas:
            assert schema_name in schemas, f"Required schema {schema_name} missing from OpenAPI spec"
    ...
    def test_openapi_spec_has_paths(self):
        ...
        assert "/task_info" in paths or "/info" in paths, "OpenAPI spec should define /task_info or /info endpoint"
