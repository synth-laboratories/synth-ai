...
def _normalize_request(input_data: Dict[str, Any]) -> Dict[str, Any]:
    """Extract TaskApp request and ensure inference_url is set."""
    request_data = input_data.get("task_app_request") or input_data
...
def main() -> int:
    ...
    request_dict = _normalize_request(input_data)
    try:
