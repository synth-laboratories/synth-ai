    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "old": {
                    "type": "string",
                    "description": "The old content to replace"
                },
                "new": {
                    "type": "string",
    ...
    async with httpx.AsyncClient(timeout=httpx.Timeout(60.0)) as client:
        async with client.stream("POST", endpoint, json=payload, headers=headers) as response:
            ...
            async for line in response.aiter_lines():
                ...
                if line.startswith("data: "):
                    ...
                    try:
                        ...
                        if chunk_count <= 5 or "function_call" in str(event) or "tool" in str(event).lower():
            ...
            if not tool_calls_found:
                ...
                print(f"  The model may have responded with text instead of using tools.")
...
async def test_chat_completions_streaming():
    ...
    print(f"  Tool format: Chat Completions (nested under 'function')")
                            ...
                            for tc in delta["tool_calls"]:
                                ...
                                if "function" in tc:
                                    if tc["function"].get("name"):
                                        ...
                                        print(f"\n  🔧 TOOL CALL START: {tc['function']['name']}")
                                    if tc["function"].get("arguments"):
                                        if idx in current_tool_call:
