...
### Phase 3: API Request/Response Types (✅ DONE)
...
### 1. Create Dataclass Module (✅ DONE)
- [x] Create `backend/app/routes/prompt_learning/types/` package
- [x] `types/scores.py` - PromptScore, scoring metrics
- [x] `types/candidates.py` - OptimizedCandidate, AttemptedCandidate
- [x] `types/validation.py` - ValidationResult, ValidationSummary
- [x] `types/archive.py` - ArchivePayload, ArchiveItem
- [x] `types/requests.py` - API request dataclasses
- [x] `types/responses.py` - API response dataclasses
- [x] `types/__init__.py` - Export all types

### 2. Create Unit Tests (✅ DONE)
- [x] `tests/unit/routes/prompt_learning/test_dataclasses.py` (all Phase 2 types)
- [x] `tests/unit/routes/prompt_learning/test_api_types.py` (all Phase 3 types)
- [x] `tests/unit/routes/prompt_learning/test_json_serialization.py` (integration)
